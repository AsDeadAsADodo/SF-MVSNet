...
if __name__ == '__main__':
    ...
    if args.resume:
        ...
        state_dict = torch.load(args.loadckpt, map_locatiMVSon=torch.device("cpu"))
    ...
    test_dataset = MVSDataset(args.testpath, args.normalpath,args.testlist, "test", args.nviews, args.numdepth)
