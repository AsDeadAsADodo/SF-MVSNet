...
parser.add_argument('--normalpath', help='testing normal dir for some scenes')
...
parser.add_argument('--filter_method', type=str, default='normal', choices=["gipuma", "normal", "dynamic", "o3d"], help="filter method")
#filter
...
def save_scene_depth(testlist):
    ...
    test_dataset = MVSDataset(args.testpath, args.normalpath, testlist, "test", args.num_view, args.numdepth, Interval_Scale,
